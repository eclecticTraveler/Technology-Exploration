...
namespace AngularTutorial.Controllers
{
    public class TodoController : ApiController
    {
        ...
        // GET api/Todo
        /// <summary>
        /// Unfortunately, the query method that WebAPI creates for us does not support 
        /// searching, sorting, or paginating. (Oddly enough, the pre-release versions of WebAPI did,
        /// but the functionality was stripped just before release!) Therefore, we will need to edit 
        /// TodoController.cs to remove GetTodoItems(), and replace it with this:
        /// 
        /// (On the parameters it reads: it can sort in asc or desc order, the q is por searching 
        /// capability, and the last 2 parameters is por paginate meaning it can limit the number of 
        /// records displayed and the offset is to start at the end record
        /// </summary>
        /// <param name="q"></param>
