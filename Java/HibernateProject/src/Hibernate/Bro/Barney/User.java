...
public class User {
    ...
    /*
     * one Hibernate.Bro.Barney.User can have many phone numbers.  CascadeType.ALL causes associated
     * phone numbers to be deleted when a Hibernate.Bro.Barney.User is deleted.
     */
    ...
    public String toString() {
        return "Hibernate.Bro.Barney.User{" +
                "id=" + id +
                ", uname='" + uname + '\'' +
                ", pword='" + pword + '\'' +
                ", active=" + active +
