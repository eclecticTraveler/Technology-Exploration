...
public class HibernateRunner {
    ...
    private void addNewUsers() {
        ...
        /*
         * create some Hibernate.Bro.Barney.User instances.
         */
        ...
        transaction.commit();
        /*
         * prove that the Hibernate.Bro.Barney.User instances were added to the database and that
    ...
    private void showAllUsers() {
        ...
        /*
         * get a list of Hibernate.Bro.Barney.User instances based on what was found in the database tables.
         */
        users = allUsersQuery.list();
        System.out.println("num users: "+ users.size());
        /*
         * iterate over each Hibernate.Bro.Barney.User instance returned by the query and found in the list.
         */
    ...
    private void modifyUser() {
        ...
        Transaction transaction = session.beginTransaction();
        /*
         * get a single Hibernate.Bro.Barney.User instance from the database.
         */
        ...
        /*
         * call the session merge method for the Hibernate.Bro.Barney.User instance in question.  This tells the database that the instance is ready to be permanently stored.
         */
    ...
    private void addSharedPhoneNumber() {
        ...
        Transaction transaction = session.beginTransaction();
        /*
         * get two Hibernate.Bro.Barney.User instances from the database using HQL.  This is NOT SQL.  It is object based.
         */
        // Bring all the user info and store it as an object base
        Query noamQuery = session.createQuery("select i from User as i where i.uname='Noam Chomsky'");
        User noamUser = (User)noamQuery.uniqueResult();
...
//        User aNameUser = (User)aNameQuery.uniqueResult();
        ...
        /*
         * create a Hibernate.Bro.Barney.PhoneNumber instance
         */
        // Lets add a phone number of Noam Chomsky
        PhoneNumber noamPhone = new PhoneNumber();
        noamPhone.setPhone("(777)777-777");
...
//       /*
//        * set the single phone number to be used by more than one Hibernate.Bro.Barney.User
//        */
...
//        aNamePhoneNumbers.add(sharedPhoneNumber);
        ...
        Set<PhoneNumber> noamPhoneNum = noamUser.getPhoneNumbers();
        noamPhoneNum.add(noamPhone);
       /*
        * inform the database that the phone number should be ready for permanent storage.
        */
//        session.save(sharedPhoneNumber);
        // Here it goes Noam Chomsky
        session.save(noamPhone);
        // Merge it with the rest
        session.merge(noamUser);

       /*
        * inform the database that the modified Hibernate.Bro.Barney.User instances should be ready for permanent storage.
        */
...
//        session.merge(aNameUser);
        ...
        */
        transaction.commit();
       /*
        * show that the database was updated by printing out all of the Hibernate.Bro.Barney.User instances created by a HQL query
        */
        showAllUsers();
    }
